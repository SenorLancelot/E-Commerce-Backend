# Generated by Django 3.1.7 on 2021-06-18 10:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.CharField(choices=[('COD', 'COD'), ('OnlinePayment', 'OnlinePayment')], default='COD', max_length=100)),
        ...
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(through='store.Cart_membership', to='store.Product'),
        ),
    ]
